...
public:
	...
	static concurrency::completion_future CalculateDrawdown(concurrency::array_view<float, 1> P, float tp, concurrency::array_view<float, 1> &D, concurrency::array_view<int, 1> &duration);
